...
fn main() {
    ...
    let storage_key = "DefaultEndpointsProtocol=https;AccountName=dgcemshdhpwmmsqi5bw9oep6;AccountKey=N2vTccY8/Gft8cjoqTsbJ646yAd2MIz6e+Y/x+zjm410jqpz/r7VUQQUq7xzirOckNAzeKohI2b9+ASt+KKuFQ==;EndpointSuffix=core.windows.net";
    let container_name = "messages";
    ...
    let storage_client =
        StorageAccountClient::new_connection_string(http_client.clone(), storage_key)
            .unwrap()
            .as_storage_client();
